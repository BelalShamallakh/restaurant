...
var KTDashboard = function () {
            ...
            data: {
                datasets: [{
                    data: [
                        ...
                        document.getElementById('review_leave').innerHTML,
                        document.getElementById('reject_leave').innerHTML,
                        document.getElementById('accept_leave').innerHTML,
                    ],
                    backgroundColor: [
    ...
    var profitShare1 = function () {
        if (!KTUtil.getByID('kt_chart_profit_share1')) {
            return;
        }
            ...
            data: {
                datasets: [{
                    data: [
                        ...
                        document.getElementById('review_salary').innerHTML,
                        document.getElementById('reject_salary').innerHTML,
                        document.getElementById('accept_salary').innerHTML,
                    ],
                    backgroundColor: [
                        KTApp.getStateColor('primary'),
                        KTApp.getStateColor('danger'),
        ...
        var ctx = KTUtil.getByID('kt_chart_profit_share1').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }


    var profitShare2 = function () {
            ...
            data: {
                datasets: [{
                    data: [
                        ...
                        document.getElementById('review_hour').innerHTML,
                        document.getElementById('reject_hour').innerHTML,
                        document.getElementById('accept_hour').innerHTML,
                    ],
                    backgroundColor: [
                        KTApp.getStateColor('primary'),
                        KTApp.getStateColor('danger'),
    ...
    var revenueChange = function () {
        ...
        Morris.Donut({
            ...
            data: [{
                    label: "تدقيق",
                    value: document.getElementById('review_leave').innerHTML
                },
                {
                    label: "مرفوض",
                    value: document.getElementById('reject_leave').innerHTML
                },
                {
                    label: "مقبول",
                    value: document.getElementById('accept_leave').innerHTML
                }
            ],
            colors: [
                KTApp.getStateColor('primary'),
    ...
    var revenueChange2 = function () {
        ...
        Morris.Donut({
            ...
            data: [{
                    label: "تدقيق",
                    value: document.getElementById('review_salary').innerHTML
                },
                {
                    label: "مرفوض",
                    value: document.getElementById('reject_salary').innerHTML
                },
                {
                    label: "مقبول",
                    value: document.getElementById('accept_salary').innerHTML
                }
            ],
            colors: [
                KTApp.getStateColor('primary'),
    ...
    var revenueChange3 = function () {
        if ($('#kt_chart_revenue_change3').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'kt_chart_revenue_change3',

            data: [{
                    label: "تدقيق",
                    value: document.getElementById('review_hour').innerHTML
                },
                {
                    label: "مرفوض",
                    value: document.getElementById('reject_hour').innerHTML
                },
                {
                    label: "مقبول",
                    value: document.getElementById('accept_hour').innerHTML
                }
            ],
            colors: [
                KTApp.getStateColor('primary'),
