...
@if (session()->has('addMassage'))
    <div class="alert alert-dismissible fade show" style="background-color:#3ec77c;color:white" role="alert">
        ...
        <strong> {{ t('Notification') }} : </strong> {{ session()->get('addMassage') }}.
    </div>
@endif
...
@if (session()->has('editMassage'))
    <div class="alert alert-dismissible fade show" style="background-color:#3ec77c;color:white" role="alert">
        ...
        <strong> {{ t('Notification') }} : </strong> {{ session()->get('editMassage') }}.
    </div>
@endif
...
@if (session()->has('deleteMassage'))
    <div class="alert alert-dismissible fade show" style="background-color:#3ec77c;color:white" role="alert">
        ...
        <strong> {{ t('Notification') }} : </strong> {{ session()->get('deleteMassage') }}.
    </div>
@endif
