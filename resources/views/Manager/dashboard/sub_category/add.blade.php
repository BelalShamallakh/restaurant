    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form id="form_manager" class="kt-form" action="{{ route('sub_category.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="form-group">
                                        <label>@lang("site." . $local . ".Sub Category Name") </label>

                                        <input type="text" name="{{$local}}[name]" class="form-control" aria-describedby="emailHelp"
                                        placeholder="@lang('site.' . $local . '.Sub Category Name')">
                                    </div>
