    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form id="form_manager" class="kt-form" action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="@lang('site.' . $local . '.Item Description')"></textarea>
                                          </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="price" class="form-control" placeholder="{{ t('Price') }}" aria-describedby="basic-addon1">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="calorie" class="form-control" placeholder="{{ t('Calorie') }}" aria-describedby="basic-addon1">
                                </div>
                            </div>
