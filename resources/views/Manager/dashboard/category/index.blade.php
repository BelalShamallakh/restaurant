                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <h4 align="center" style="margin:0;" class="text-danger">{{ t('If this item is deleted, all Sub Categories and Items will be deleted') }}  </h4>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var table = $('.datatable').DataTable({
            ...
            info: false,
            searching:false,
            ajax: "{{ route('category.getCategoryData') }}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
