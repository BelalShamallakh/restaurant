...
class Color extends \Faker\Provider\Color
{
    ...
    protected static $allColorNames = array(
        ...
        'أخضر (نظام الألوان الطبيعية)', 'أخضر الصياد', 'أخضر الغابة (تقليدي)', 'أخضر الغابة (وب)', 'أخضر الغرب',
        ...
        'توردي', 'جاسبري', 'جلدي الجاموس', 'جمشتي', 'جملي', 'جوزي الغرب', 'حسائي', 'حممي داكن', 'خامي',
